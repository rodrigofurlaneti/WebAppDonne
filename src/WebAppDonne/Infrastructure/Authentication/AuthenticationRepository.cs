...
namespace WebApi.Donne.Infrastructure.Authentication
{
    public class AuthenticationRepository : BaseRepository, IAuthenticationRepository
    {
        ...
        public IEnumerable<AuthenticationModel> GetAll()
        {
            try
            {
            ...
            {
                logger.TraceException("Authentication_GetAll");
                string mensagem = "Erro ao consumir a controler Authentication, rota GetAllAuthentication " + ex.Message;
                throw new ArgumentNullException(mensagem);
            }
        }

        public async Task<IEnumerable<AuthenticationModel>> GetAllAsync()
        {
            try
            {
            ...
            {
                logger.TraceException("Authentication_GetAllAsync");
        ...
        public AuthenticationModel GetById(int id)
        {
            ...
            {
                logger.TraceException("Authentication_GetById");
        ...
        public async Task<AuthenticationModel> GetByIdAsync(int id)
        {
            try
            {
                logger.Trace("Authentication_GetByIdAsync");
                commandText = "USP_Donne_Authentication_GetById";
                AuthenticationModel AuthenticationModel = new AuthenticationModel();
                using (SqlConnection sqlConnection = new SqlConnection(connectionString))
                {
            ...
            {
                logger.TraceException("Authentication_GetByIdAsync");
        ...
        public void Insert(AuthenticationModel AuthenticationModel)
        {
            ...
            {
                logger.TraceException("Authentication_Insert");
