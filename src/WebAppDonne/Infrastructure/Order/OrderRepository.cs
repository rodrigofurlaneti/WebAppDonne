...
namespace WebApi.Donne.Infrastructure.Order
{
    public class OrderRepository : BaseRepository, IOrderRepository
    {
        ...
        public OrderRepository(SeedWork.ILogger logger) : base(logger) { }
        ...
        public IEnumerable<OrderModel> GetAll()
        {
            ...
            catch (ArgumentNullException ex)
            {
                ...
                logger.TraceException("Order_GetAll");
        ...
        public async Task<IEnumerable<OrderModel>> GetAllAsync()
        {
            ...
            {
                logger.TraceException("Order_GetAllAsync");
        ...
        public OrderModel GetById(int id)
        {
            ...
            {
                logger.TraceException("Order_GetById");
        ...
        public async Task<OrderModel> GetByIdAsync(int id)
        {
            ...
            {
                logger.TraceException("Order_GetByIdAsync");
        ...
        public void Insert(OrderModel orderModel)
        {
            ...
            {
                logger.TraceException("Order_Insert");
        ...
        public async Task InsertAsync(OrderModel orderModel)
        {
            try
            {
                logger.Trace("Order_InsertAsync");
                commandText = "USP_Donne_Order_Insert";
                SqlConnection sqlConnection = new SqlConnection(connectionString);
                SqlCommand sqlCommand = new SqlCommand(commandText, sqlConnection);
                GetSqlCommandOrderModelInsert(sqlCommand, orderModel);
            ...
            {
                logger.TraceException("Order_InsertAsync");
        ...
        public void Delete(int orderId)
        {
            ...
            {
                logger.TraceException("Order_Delete");
        ...
        public async Task DeleteAsync(int orderId)
        {
            try
            {
                logger.Trace("Order_DeleteAsync");
                commandText = "USP_Donne_Order_Delete";
                SqlConnection sqlConnection = new SqlConnection(connectionString);
                SqlCommand sqlCommand = new SqlCommand(commandText, sqlConnection);
                sqlCommand.Parameters.AddWithValue("@OrderId", orderId);
            ...
            catch (Exception ex)
            {
                ...
                logger.TraceException("Order_DeleteAsync");
                throw new ArgumentNullException(mensagemErro);
            }
        ...
        public void Update(OrderModel orderModel)
        {
            ...
            catch (ArgumentNullException ex)
            {
                ...
                logger.TraceException("Order_Update");
                throw new ArgumentNullException(mensagemErro);
            }
        }
        ...
        public async Task UpdateAsync(OrderModel orderModel)
        {
            try
            {
                logger.Trace("Order_UpdateAsync");
                commandText = "USP_Donne_Order_Update";
                SqlConnection sqlConnection = new SqlConnection(connectionString);
                SqlCommand sqlCommand = new SqlCommand(commandText, sqlConnection);
                GetSqlCommandOrderModelUpdate(sqlCommand, orderModel);
            ...
            {
                logger.TraceException("Order_UpdateAsync");
