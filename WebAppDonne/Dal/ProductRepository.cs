        ...
        public IEnumerable<ProductModel> GetAllProducts()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                while (rdr.Read())
                {
                    ...
                    product.CostPrice = Convert.ToDecimal(rdr["CostPrice"]);
                    product.SalePrice = Convert.ToDecimal(rdr["SalePrice"]);
                    ...
                    product.TotalValueCostOfInventory = Convert.ToDecimal(rdr["TotalValueCostOfInventory"]);
                    product.TotalValueSaleStock = Convert.ToDecimal(rdr["TotalValueSaleStock"]);
